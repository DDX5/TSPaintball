...
public class BlueMedkitBlock extends Block
{
    ...
    public BlueMedkitBlock()
    {
        super(Properties.of(Material.HEAVY_METAL).noOcclusion().noCollission().randomTicks());
    ...
    public ActionResultType use(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult rayTraceResult)
    {
        ...
        {
            int R = PlayerDataHandler.IsSameTeam(Tag,"blue");
            if(R != 1)
            {
